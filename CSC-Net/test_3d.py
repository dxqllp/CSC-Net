...
parser.add_argument('--exp', type=str,  default='CCNET', help='exp_name')
parser.add_argument('--model', type=str,  default='ccnet3d_v1', help='model_name')
...
def test_calculate_metric():
    ...
    net = net_factory(net_type='ccnet3d_v1', in_chns=1, class_num=num_classes, mode="test")
