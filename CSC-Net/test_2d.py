...
parser.add_argument('--labelnum', type=int, default=21, help='labeled data')
...
def test_single_volume(case, net, test_save_path, FLAGS):
    h5f = h5py.File(FLAGS.root_path + "/3d/{}.h5".format(case), 'r')
    image = h5f['image'][:]
    label = h5f['label'][:]
...
def Inference(FLAGS):
    ...
    net = net_factory(net_type='mcnet2d_v2', in_chns=1, class_num=FLAGS.num_classes)
